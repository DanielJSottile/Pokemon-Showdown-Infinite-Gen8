...
defrost: Cures the user if executed successfully while the user is frostbitten.
...
let BattleMovedex = {
	...
	"alphabeticalorder": {
		...
		onTryMove(pokemon, target, move) {
			if (pokemon.template.species === 'Unown-Alphabet' || move.hasBounced) {
				return;
			}
			this.add('-fail', pokemon, 'move: Alphabetical Order');
			this.hint("Only a Pokemon whose form is Unown Alphabet can use this move.");
			return null;
		},
		onTryHit(pokemon) {
		...
		effect: {
			...
			onTryHit(target, source, move) {
				...
				if (move.flags['contact']) {
					this.boost({spa: 2}, target, this.dex.getActiveMove("Alphabetical Order"));
					this.add('-message', 'Targeting the impenetrable wall gave Unown a boost');
	...
	"alphastrike": {
		...
		flags: {protect: 1, mirror: 1},
		onTry(pokemon) {
			if (pokemon.template.species === 'Unown-Alphabet') {
				return;
			}
			this.hint("Only a Pokemon whose form is Unown-Alphabet can use this move.");
	...
	"aurasphere": {
		...
		basePower: 80,
		category: "Special",
		shortDesc: "This move has a 10% chance to cause whiplash to the target.  Does not check accuracy.",
		id: "aurasphere",
		isViable: true,
		name: "Aura Sphere",
		pp: 20,
	...
	"auroraveil": {
		...
		basePower: 0,
		category: "Status",
		desc: "For 5 turns, the user and its party members take 0.66x damage from physical and special attacks, or 0.75x damage if in a Double Battle; does not reduce damage further with Reflect or Light Screen. Critical hits ignore this protection. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Brick Break and Psychic Fangs remove the effect before damage is calculated. Lasts for 8 turns if the user is holding Light Clay. Fails unless the weather is Hail.",
		shortDesc: "For 5 turns, damage to allies is 0.66x. Hail only.",
		id: "auroraveil",
		isViable: true,
		name: "Aurora Veil",
		pp: 20,
	...
	"bind": {
		...
		basePower: 15,
		category: "Physical",
		desc: "Prevents the target from switching for one to three turns (five turns if the user is holding Grip Claw). Causes damage to the target equal to 1/8 of its maximum HP (1/6 if the user is holding Binding Band), rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Parting Shot, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field, or if the target uses Rapid Spin or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
		shortDesc: "Traps and damages the target for 1-3 turns.",
		id: "bind",
		name: "Bind",
		pp: 20,
		priority: 0,
	...
	"boltbeak": {
		...
		category: "Physical",
		desc: "If the user moves before the target, this move's power is multiplied by 1.8x.",
		shortDesc: "1.8x power if the user moves first.",
		id: "boltbeak",
		name: "Bolt Beak",
		pp: 10,
		priority: 0,
	...
	"courtchange": {
		...
		basePower: 0,
		category: "Status",
		desc: "Switches the Mist, Light Screen, Reflect, Safeguard, Spikes, Toxic Spikes, Tailwind, Stealth Rock, Water Pledge, Fire Pledge, Grass Pledge, Sticky Web, Aurora Veil, Metal Shard, Volcanic Ash, and Forest Fire effects from the user's side to the target's side and vice versa.",
		...
		onHitField(target, source) {
			...
			const sideConditions = [
				'spikes', 'toxicspikes', 'stealthrock', 'metalshard', 'stickyweb', 'lightscreen', 'reflect', 'safeguard', 'auroraveil', 'tailwind', 'mist', 'waterpledge', 'firepledge', 'grasspledge', 'wildfire', 'volcanicash',
			];
			let success = false;
	...
	"darkvoid": {
		...
		shortDesc: "Darkrai/Apocalylidae: Causes the foe(s) to fall asleep.",
		id: "darkvoid",
		isViable: true,
		name: "Dark Void",
		pp: 10,
	...
	"dazzlinggleam": {
		...
		basePower: 80,
		category: "Special",
		desc: "Has a 10% chance to bewitch the target, hits adjacent foes.",
		shortDesc: "10% chance to bewitch the target, hits adjacent foes.",
		id: "dazzlinggleam",
		isViable: true,
		name: "Dazzling Gleam",
		pp: 10,
	...
	"defog": {
		...
		basePower: 0,
		category: "Status",
		desc: "Lowers the target's evasiveness by 1 stage. If this move is successful and whether or not the target's evasiveness was affected, the effects of Reflect, Light Screen, Aurora Veil, Safeguard, Mist, Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the target's side, and the effects of Spikes, Toxic Spikes, Stealth Rock, and Sticky Web end for the user's side. This also clears all Terrains from the field.  Ignores a target's substitute, although a substitute will still block the lowering of evasiveness.",
		...
		onHit(target, source, move) {
			...
			let removeTarget = ['reflect', 'lightscreen', 'auroraveil', 'safeguard', 'mist', 'spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'metalshard'];
			let removeAll = ['spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'metalshard'];
	...
	"electricterrain": {
		...
		effect: {
			...
			onBasePower(basePower, attacker, defender, move) {
				if (move.type === 'Electric' && (attacker.isGrounded() || attacker.hasAbility('surgesurfer')) && !attacker.isSemiInvulnerable()) {
	...
	"fairywind": {
		...
		basePower: 40,
		category: "Special",
		desc: "Has a 30% chance to bewitch the target.",
		shortDesc: "30% chance to bewitch the target.",
		id: "fairywind",
		name: "Fairy Wind",
		pp: 30,
		priority: 0,
	...
	"feintattack": {
		...
		basePower: 60,
		category: "Physical",
		shortDesc: "This move has a 10% chance to blind the target, does not check accuracy.",
		id: "feintattack",
		name: "Feint Attack",
		pp: 20,
		priority: 0,
	...
	"flamewheel": {
		...
		category: "Physical",
		desc: "Has a 10% chance to burn the target.",
		shortDesc: "10% chance to burn the target. Cures frostbite.",
		id: "flamewheel",
		name: "Flame Wheel",
		pp: 25,
		priority: 0,
	...
	"flareblitz": {
		...
		shortDesc: "Has 33% recoil. 10% chance to burn. Cures frostbite.",
		id: "flareblitz",
		isViable: true,
		name: "Flare Blitz",
		pp: 15,
	...
	"gmaxdrumsolo": {
		...
		basePower: 10,
		category: "Physical",
		desc: "Ignores foes ability.",
		shortDesc: "Ignores foes ability.",
		id: "gmaxdrumsolo",
		isNonstandard: "Custom",
	...
	"gmaxwindrage": {
		...
		desc: "Removes Reflect, Light Screen, Aurora Veil, Spikes, Toxic Spikes, Stealth Rock, Sticky Web, Mist, Safeguard, Metal Shard, and Terrains from the field. This move's Base Power scales with the base move's Base Power.",
	...
	"hiddenpower": {
		...
		basePower: 60,
		basePowerCallback(pokemon, target, move) {
			if (pokemon.template.species === 'Unown-Alphabet' && pokemon.hasAbility('unownsspell')) {
	...
	"icefang": {
		...
		basePower: 65,
		category: "Physical",
		desc: "Has a 10% chance to frostbite the target and a 10% chance to flinch it.",
	...
	"infinitepotentialgeyser": {
		num: -16,
		accuracy: true,
		basePower: 170,
		category: "Special",
		desc: "This move becomes a physical attack if the user's Attack is greater than its Special Attack, including stat stage changes. This move and its effects ignore the Abilities of other Pokemon.  This also boosts all stats by 1 stage",
		shortDesc: "Physical if user's Atk > Sp. Atk. Ignores Abilities, boosts stats by 1 stage",
		id: "infinitepotentialgeyser",
		name: "Infinite Potential Geyser",
		pp: 1,
		priority: 0,
		flags: {},
		selfBoost: {
	...
	"inverseroom": {
		...
		effect: {
			...
			onStart(target, source) {
				...
				this.add('-message', 'The type-effectiveness of the room has been twisted!');
			},
			onRestart(target, source) {
			...
			onResidualOrder: 25,
			onEnd() {
				this.add('-fieldend', 'move: Inverse Room', '[of] ' + this.effectData.source);
	...
	"landswrath": {
		...
		effect: {
			duration: 4,
			onStart(targetSide) {
				this.add('-sidestart', targetSide, "Land's Wrath");
			},
			onResidual(targetSide) {
				for (const pokemon of targetSide.active) {
					if (!pokemon.hasType('Ground')) this.damage(pokemon.baseMaxhp / 6, pokemon);
				}
			},
			onEnd(targetSide) {
				this.add('-sideend', targetSide, "Land's Wrath");
			},
		},
		secondary: null,
		target: "allAdjacentFoes",
	...
	"maxairstream": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "User: 20% chance +1 Speed. BP scales with base move's BP.",
		id: "maxairstream",
		isViable: true,
		name: "Max Airstream",
		pp: 5,
	...
	"maxdarkness": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "Foes: 20% chance -1 Sp.Def. BP scales with base move's BP.",
		id: "maxdarkness",
		isViable: true,
		name: "Max Darkness",
		pp: 5,
	...
	"maxdestruction": {
		...
		basePower: 10,
		category: "Special",
		shortDesc: "20% chance sets Maelstrom. BP scales with base move's BP.",
		id: "maxdescruction",
		isViable: true,
	...
	"maxflare": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Sun. BP scales with base move's BP.",
		id: "maxflare",
		isViable: true,
		name: "Max Flare",
		pp: 5,
	...
	"maxflutterby": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "Foes: 20% chance -1 Sp.Atk. BP scales with base move's BP.",
		id: "maxflutterby",
		isViable: true,
		name: "Max Flutterby",
		pp: 5,
	...
	"maxgeyser": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Rain. BP scales with base move's BP.",
		id: "maxgeyser",
		isViable: true,
		name: "Max Geyser",
		pp: 5,
	...
	"maxhailstorm": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Hail. BP scales with base move's BP.",
		id: "maxhailstorm",
		isViable: true,
		name: "Max Hailstorm",
		pp: 5,
	...
	"maxknuckle": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "User: 20% chance +1 Attack. BP scales with base move's BP.",
		id: "maxknuckle",
		isViable: true,
		name: "Max Knuckle",
		pp: 5,
	...
	"maxlightning": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Electric Terrain. BP scales with base move's BP.",
		id: "maxlightning",
		isViable: true,
		name: "Max Lightning",
		pp: 5,
	...
	"maxmindstorm": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Psychic Terrain. BP scales with base move's BP.",
		id: "maxmindstorm",
		isViable: true,
		name: "Max Mindstorm",
		pp: 5,
	...
	"maxooze": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "User: 20% chance +1 Sp.Atk. BP scales with base move's BP.",
		id: "maxooze",
		isViable: true,
		name: "Max Ooze",
		pp: 5,
	...
	"maxovergrowth": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Grassy Terrain. BP scales with base move's BP.",
		id: "maxovergrowth",
		isViable: true,
		name: "Max Overgrowth",
		pp: 5,
	...
	"maxphantasm": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "Foes: 20% chance -1 Defense. BP scales with base move's BP.",
		id: "maxphantasm",
		isViable: true,
		name: "Max Phantasm",
		pp: 5,
	...
	"maxquake": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "User: 20% chance +1 Sp.Def. BP scales with base move's BP.",
		id: "maxquake",
		isViable: true,
		name: "Max Quake",
		pp: 5,
	...
	"maxrockfall": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Sandstorm. BP scales with base move's BP.",
		id: "maxrockfall",
		isViable: true,
		name: "Max Rockfall",
		pp: 5,
	...
	"maxstarfall": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "20% chance sets Misty Terrain. BP scales with base move's BP.",
		id: "maxstarfall",
		isViable: true,
		name: "Max Starfall",
		pp: 5,
	...
	"maxsteelspike": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "User: 20% chance +1 Defense. BP scales with base move's BP.",
		id: "maxsteelspike",
		isViable: true,
		name: "Max Steelspike",
		pp: 5,
	...
	"maxstrike": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "Foes: 20% chance -1 Speed. BP scales with base move's BP.",
		id: "maxstrike",
		isViable: true,
		name: "Max Strike",
		pp: 5,
	...
	"maxwyrmwind": {
		...
		basePower: 10,
		category: "Physical",
		shortDesc: "Foes: 20% chance -1 Attack. BP scales with base move's BP.",
		id: "maxwyrmwind",
		isViable: true,
		name: "Max Wyrmwind",
		pp: 5,
	...
	"moonlight": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user restores 1/2 of its maximum HP if Delta Stream or no weather conditions are in effect, 2/3 of its maximum HP if the weather is Hail, Primordial Sea, Rain Dance, or Sandstorm, and 1/4 of its maximum HP if the weather is Sunny Day or Desolate Land, all rounded half down.",
	...
	"multiattack": {
		...
		onModifyMove(move, pokemon) {
			if (pokemon.ignoringItem()) return;
			const item = pokemon.getItem();
			if (item.id && item.onMemory && !item.zMove) {
	...
	"mysticalfire": {
		...
		basePower: 75,
		basePowerCallback(pokemon, target, move) {
			if (pokemon.template.species === 'Delphox-Serena' && pokemon.hasAbility('battlebond')) {
	...
	"nightdaze": {
		...
		basePower: 85,
		category: "Special",
		desc: "Has a 30% chance to blind the target.",
		shortDesc: "30% chance to blind the target.",
		id: "nightdaze",
		name: "Night Daze",
		pp: 10,
		priority: 0,
		...
		onHit(target, source, move) {
			...
			for (const sideCondition of removeAll) {
				if (source.side.removeSideCondition(sideCondition)) {
					this.add('-sideend', source.side, this.dex.getEffect(sideCondition).name, '[from] move: Defog', '[of] ' + source);
					success = true;
					this.add('-message', 'The field was reset to its original state');
				}
			}
			return success;
		},
	...
	"playrough": {
		...
		basePower: 90,
		category: "Physical",
		desc: "Has a 10% chance to bewitch the target.",
		shortDesc: "10% chance to bewitch the target.",
		id: "playrough",
		isViable: true,
		name: "Play Rough",
		pp: 10,
	...
	"powertrick": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user swaps its Attack and Sp. Att with it's Defense  and Sp. Def stats, and stat stage changes remain on their respective stats. This move can be used again to swap the stats back. If the user uses Baton Pass, the replacement will have its Attack and Defense stats swapped if the effect is active. If the user has its stats recalculated by changing forme while its stats are swapped, this effect is ignored but is still active for the purposes of Baton Pass.",
		shortDesc: "Switches user's Attack/SpA with Defense/SpDef stats.",
		id: "powertrick",
		name: "Power Trick",
		pp: 10,
		priority: 0,
	...
	"rapidspin": {
		...
		self: {
			onHit(pokemon) {
				...
				let sideConditions = ['spikes', 'toxicspikes', 'stealthrock', 'stickyweb', 'metalshard'];
	...
	"reflect": {
		...
		basePower: 0,
		category: "Status",
		desc: "For 5 turns, the user and its party members take 0.66x damage from physical attacks, or 0.75x damage if in a Double Battle. Damage is not reduced further with Aurora Veil. Critical hits ignore this effect. It is removed from the user's side if the user or an ally is successfully hit by Brick Break, Psychic Fangs, or Defog. Lasts for 8 turns if the user is holding Light Clay. Fails if the effect is already active on the user's side.",
		shortDesc: "For 5 turns, physical damage to allies is 0.66x.",
		id: "reflect",
		isViable: true,
		name: "Reflect",
		pp: 20,
	...
	"refresh": {
		...
		basePower: 0,
		category: "Status",
		desc: "The user cures its non-sleep status. Fails if the user is not burned, poisoned, or paralyzed.",
		shortDesc: "User cures its non-sleep status.",
		id: "refresh",
		isViable: true,
		name: "Refresh",
		pp: 20,
	...
	"revealingjudgment": {
		...
		onHit(pokemon, source, move) {
			if (pokemon.template.species === 'Unown-Alphabet' && move.category !== 'Status') {
				pokemon.volatiles['revealingjudgemet'] = true;
				let healedBy = this.heal(pokemon.maxhp / 3);
				pokemon.removeVolatile('revealingjudgment');
				return !!healedBy;
				this.add('-message', 'Unown revealed the true intentions of the foe!');
					}
				}
			},
		heal: [1, 3],
	...
	risingvoltage: {
		...
		basePower: 70,
		category: "Special",
		desc: "If the current terrain is Electric Terrain and the target is grounded, this move's power is 2x.",
	...
	"rocksmash": {
		...
		basePower: 40,
		category: "Physical",
		desc: "Has a 50% chance to cause whiplash.",
		shortDesc: "50% chance to cause whiplash.",
		id: "rocksmash",
		name: "Rock Smash",
		pp: 15,
		priority: 0,
	...
	"sacredfire": {
		...
		shortDesc: "50% chance to burn the target. Cures frostbite.",
		id: "sacredfire",
		isViable: true,
		name: "Sacred Fire",
		pp: 5,
	...
	"scald": {
		...
		basePower: 80,
		category: "Special",
		desc: "Has a 25% chance to burn the target. Cures the target of frostbite.",
		shortDesc: "25% chance to burn the target. Cures frostbite.",
		id: "scald",
		isViable: true,
		name: "Scald",
		pp: 15,
	...
	"skullbash": {
		...
		shortDesc: "Raises user's Atk and Def by 1 on turn 1. Hits turn 2.",
		id: "skullbash",
		name: "Skull Bash",
		pp: 10,
		priority: 0,
		...
		onTryMove(attacker, defender, move) {
			...
			this.add('-prepare', attacker, move.name, defender);
			this.boost({att: 1, def: 1}, attacker, attacker, move);
			if (!this.runEvent('ChargeMove', attacker, defender, move)) {
				return;
			}
			attacker.addVolatile('twoturnmove', defender);
	...
	"steameruption": {
		...
		basePower: 110,
		category: "Special",
		desc: "Has a 30% chance to burn the target. Cures the target of frostbite.",
	...
	"stoneedge": {
		...
		category: "Physical",
		desc: "Has a higher chance for a critical hit.",
		shortDesc: "Higher critical hit ratio.",
		id: "stoneedge",
		isViable: true,
		name: "Stone Edge",
		pp: 5,
	...
	"submission": {
		...
		basePower: 80,
		category: "Physical",
		desc: "Has a 20% chance to cause whiplash, has 1/4 recoil.",
		shortDesc: "Has 1/4 recoil.",
		id: "submission",
		name: "Submission",
		pp: 20,
		...
		effect: {
			...
			onEnd(target) {
				if (target && !target.fainted) {
					...
					if (damage) this.add('-heal', target, target.getHealth, "[from] move: Time's Arrow", '[wisher] ' + this.effectData.source.name);
	...
	"weatherball": {
		...
		basePower: 50,
		category: "Special",
		desc: "Power doubles if any weather condition is active, and this move's type changes to match. Ice type during Hail, Water type during Primordial Sea or Rain Dance, Rock type during Sandstorm, Flying during Delta Stream, and Fire type during Desolate Land or Sunny Day. If the user is holding Utility Umbrella and uses Weather Ball during any Weather, the move is still Normal-type and does not have a base power boost.",
	...
	"zippyzap": {
		...
		basePower: 80,
		category: "Physical",
		desc: "Nearly always goes first.  Has a small chance to land a Critical hit.",
		shortDesc: "Nearly always goes first. Crit chance x1.",
		id: "zippyzap",
		isViable: true,
		name: "Zippy Zap",
		pp: 15,

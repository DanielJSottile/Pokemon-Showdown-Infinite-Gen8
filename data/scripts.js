...
let BattleScripts = {
	...
	runMegaEvo(pokemon) {
		...
		for (const foeActive of side.foe.active) {
			if ((foeActive.volatiles['skydrop'] && foeActive.volatiles['skydrop'].source === pokemon) || (foeActive.volatiles['psychokinesis'] && foeActive.volatiles['psychokinesis'].source === pokemon)) {
				return false;
			}
		}

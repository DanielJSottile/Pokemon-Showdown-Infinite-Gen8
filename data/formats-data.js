...
let BattleFormatsData = {
	...
	chesnaughtclemont: {
		randomBattleMoves: ["leechseed", "synthesis", "spikes", "drainpunch", "spikyshield", "woodhammer"],
		eventPokemon: [
			{"generation": 7, "level": 36, "ivs": {"hp": 20, "atk": 31, "def": 20, "spa": 31, "spd": 20, "spe": 31}, "moves": ["woodhammer", "drainpunch", "synthesis", "spikyshield"], "pokeball": "pokeball"},
		],
		eventOnly: true,
		gen: 7,
	...
	delphoxserena: {
		...
		eventPokemon: [
			{"generation": 7, "level": 36, "ivs": {"hp": 20, "atk": 31, "def": 20, "spa": 31, "spd": 20, "spe": 31}, "moves": ["fireblast", "psyshock", "calmmind", "mysticalfire"], "pokeball": "pokeball"},
		],
		eventOnly: true,
		gen: 7,
		requiredAbility: "Battle Bond",
	...
	apocalylidae: {
		...
		eventPokemon: [
			{"generation": 8, "level": 100, "moves": ["apocalypticmaelstrom", "darkvoid", "precipiceblades", "oblivionwing"]},
		],
		eventOnly: true,
		tier: "AG",
		doublesTier: "DUber",

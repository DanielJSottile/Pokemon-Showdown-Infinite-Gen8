...
let BattleFormatsData = {
	...
	mebiusanfuture: {
		randomBattleMoves: ["morningsun", "futuresreckoning", "swordsdance", "timesarrow", "originpulse", "partingshot"],
		randomDoubleBattleMoves: ["morningsun", "futuresreckoning", "swordsdance", "timesarrow", "originpulse", "partingshot", "protect"],
		eventPokemon: [
			{"generation": 8, "level": 49, "moves": ["futuresreckoning"]},
		],
		tier: "AG",
		doublesTier: "DUber",
	},
	...
	gorochugmax: {
		isGigantamax: "G-Max Electrocution",
		tier: "OU",
		doublesTier: "DOU",
	},
	sandshrew: {
	...
	arcaninemega: {
		randomBattleMoves: ["doubleedge", "wildcharge", "extremespeed", "closecombat", "morningsun", "willowisp", "toxic", "crunch", "roar"],
		randomDoubleBattleMoves: ["doubleedge", "wildcharge", "closecombat", "willowisp", "snarl", "protect", "extremespeed"],
	...
	rapidashmega: {
		...
		randomDoubleBattleMoves: ["flareblitz", "wildcharge", "protect", "drillpeck", "flamecharge", "megahorn", "drillrun", "willowisp"],
	...
	gengar: {
		randomBattleMoves: ["shadowball", "sludgewave", "focusblast", "substitute", "disable", "painsplit", "nastyplot"],
		randomDoubleBattleMoves: ["shadowball", "sludgebomb", "focusblast", "substitute", "disable", "taunt", "hypnosis", "nastyplot", "dazzlinggleam", "protect"],
		eventPokemon: [
	...
	gengarmega: {
		randomBattleMoves: ["shadowball", "sludgewave", "focusblast", "taunt", "destinybond", "disable", "perishsong", "nastyplot"],
		randomDoubleBattleMoves: ["shadowball", "sludgebomb", "focusblast", "substitute", "disable", "taunt", "hypnosis", "nastyplot", "dazzlinggleam", "protect"],
	...
	magmortarmega: {
		randomBattleMoves: ["fireblast", "focusblast", "flashcannon", "hiddenpowerice", "thunderbolt", "earthquake", "substitute"],
		randomDoubleBattleMoves: ["fireblast", "taunt", "focusblast", "flashcannon", "hiddenpowerice", "thunderbolt", "heatwave", "willowisp", "protect", "followme"],
	...
	phantasmeon: {
		randomBattleMoves: ["spookyspook", "mysticalfire", "willowisp", "hex", "haze", "strangesteam"],
		randomDoubleBattleMoves: ["spookyspook", "mysticalfire", "willowisp", "hex", "haze", "strangesteam", "protect"],
		tier: "RU",
		doublesTier: "DUU",
	},
	titaneon: {
		randomBattleMoves: ["pointypoint", "spikes", "wish", "swordsdance", "metalshard", "protect"],
		randomDoubleBattleMoves: ["pointypoint", "spikes", "wish", "swordsdance", "metalshard", "protect"],
		tier: "RU",
		doublesTier: "DUU",
	},
	porygon: {
	...
	mewtwoarmored: {
		randomBattleMoves: ["shellsmash", "earthquake", "zenheadbutt", "irontail", "drainpunch", "recover"],
		randomDoubleBattleMoves: ["shellsmash", "earthquake", "zenheadbutt", "irontail", "drainpunch", "recover","protect"],
		tier: "AG",
		doublesTier: "DUber",
	},
	mew: {
	...
	meganiummega: {
		randomBattleMoves: ["gigadrain", "drainingkiss", "hiddenpowerfire", "synthesis", "toxic", "workup", "aromatherapy"],
		randomDoubleBattleMoves: ["gigadrain", "drainingkiss", "hiddenpowerfire", "synthesis", "toxic", "workup", "aromatherapy", "protect"],
	...
	sunfloramega: {
		...
		randomDoubleBattleMoves: ["sunnyday", "gigadrain", "solarbeam", "weatherball", "hiddenpowerice", "earthpower", "protect", "encore"],
	...
	yanmega: {
		randomBattleMoves: ["bugbuzz", "airslash", "dragonpulse", "protect", "gigadrain"],
		tier: "NUBL",
		doublesTier: "(DUU)",
	},
	yanmegamega: {
	...
	ziraphariz: {
		randomBattleMoves: ["psychic", "psyshock", "thunderbolt", "nastyplot", "substitute", "darkpulse", "nightdaze", "burningjealousy", "leafstorm", "agility"],
		randomDoubleBattleMoves: ["psychic", "psyshock", "thunderbolt", "nastyplot", "substitute", "darkpulse", "nightdaze", "burningjealousy", "leafstorm", "agility", "protect"],
		tier: "NU",
		doublesTier: "(DUU)",
	},
	pineco: {
	...
	dunsparcemega: {
		randomBattleMoves: ["earthquake", "dragonrush", "coil", "glare", "outrage", "roost", "landswrath"],
		randomDoubleBattleMoves: ["coil", "earthquake", "landswrath", "earthquake", "glare", "outrage", "protect", "roost"],
	...
	mantineaumagari: {
		randomBattleMoves: ["scald", "discharge", "airslash", "zapcannon", "roost", "toxic", "defog"],
		randomDoubleBattleMoves: ["scald", "discharge", "airslash", "zapcannon", "roost", "toxic", "defog", "protect"],
		tier: "RU",
		doublesTier: "(DUU)",
	},
	skarmory: {
	...
	raikouaumagari: {
		randomBattleMoves: ["thunderbolt", "flamethrower", "aurasphere", "nastyplot", "substitute", "voltswitch", "sludgewave"],
		randomDoubleBattleMoves: ["thunderbolt", "flamethrower", "aurasphere", "nastyplot", "substitute", "voltswitch", "sludgewave", "protect"],
		tier: "RUBL",
		doublesTier: "(DUU)",
	},
	enteiaumagari: {
	...
	suicuneaumagari: {
		randomBattleMoves: ["moonblast", "icebeam", "auroraveil", "mysticalfire", "rest", "sleeptalk", "calmmind", "protect", "substitute"],
		randomDoubleBattleMoves: ["moonblast", "icebeam", "auroraveil", "mysticalfire", "rest", "sleeptalk", "calmmind", "protect", "substitute"],
		tier: "RUBL",
		doublesTier: "DOU",
	},
	larvitar: {
	...
	mightyenamega: {
		randomBattleMoves: ["shadowbone", "crunch", "suckerpunch", "playrough", "firefang", "irontail"],
		randomDoubleBattleMoves: ["shadowbone", "suckerpunch", "crunch", "playrough", "firefang", "taunt", "protect"],
	...
	delcattymega: {
		randomBattleMoves: ["fakeout", "doubleedge", "thunderwave", "spiritbreak", "wildcharge", "suckerpunch", "healbell"],
		randomDoubleBattleMoves: ["fakeout", "doubleedge", "thunderwave", "spiritbreak", "wildcharge", "suckerpunch", "healbell", "protect"],
	...
	flygonmega: {
		randomBattleMoves: ["earthquake", "outrage", "attackorder", "roost", "defog", "firepunch", "dragondance"],
		randomDoubleBattleMoves: ["earthquake", "protect", "dragonclaw", "attackorder", "rockslide", "firepunch", "fireblast", "tailwind", "dragondance"],
	...
	miloticmega: {
		randomBattleMoves: ["recover", "scald", "toxic", "icebeam", "dragontail", "moonblast", "coil"],
		randomDoubleBattleMoves: ["recover", "scald", "hydropump", "icebeam", "dragontail", "moonblast", "protect", "hiddenpowergrass"],
	...
	castformmega: {
		randomBattleMoves: ["hurricane", "fireblast", "solarbeam", "icebeam", "thunder"],
		randomDoubleBattleMoves: ["hurricane", "fireblast", "solarbeam", "icebeam", "thunder"],
	...
	latias: {
		randomBattleMoves: ["dracometeor", "psyshock", "flamethrower", "roost", "thunderbolt", "healingwish", "defog"],
		randomDoubleBattleMoves: ["dragonpulse", "psychic", "tailwind", "helpinghand", "healpulse", "lightscreen", "reflect", "protect"],
		tier: "UU",
		doublesTier: "(DUU)",
	},
	latiasmega: {
		randomBattleMoves: ["calmmind", "dragonpulse", "surf", "dracometeor", "roost", "flamethrower", "substitute", "psyshock"],
		randomDoubleBattleMoves: ["dragonpulse", "psychic", "tailwind", "helpinghand", "healpulse", "lightscreen", "reflect", "protect"],
	...
	latios: {
		randomBattleMoves: ["dracometeor", "flamethrower", "surf", "thunderbolt", "psyshock", "roost", "trick", "defog"],
		randomDoubleBattleMoves: ["dracometeor", "dragonpulse", "surf", "thunderbolt", "psyshock", "substitute", "trick", "tailwind", "protect", "flamethrower"],
		tier: "UU",
		doublesTier: "(DUU)",
	},
	latiosmega: {
		randomBattleMoves: ["calmmind", "dracometeor", "flamethrower", "psyshock", "roost", "defog"],
		randomDoubleBattleMoves: ["dracometeor", "dragonpulse", "surf", "thunderbolt", "psyshock", "substitute", "tailwind", "protect", "flamethrower"],
	...
	garchompaumagari: {
		randomBattleMoves: ["outrage", "dragonclaw", "liquidation", "earthquake", "stoneedge", "blizzard", "swordsdance", "stealthrock"],
		randomDoubleBattleMoves: ["outrage", "dragonclaw", "liquidation", "earthquake", "stoneedge", "blizzard", "swordsdance", "stealthrock"],
		tier: "OU",
		doublesTier: "DUU",
	},
	garchompmega: {
	...
	hippowdonaumagari: {
		randomBattleMoves: ["earthquake", "slackoff", "whirlwind", "stealthrock", "toxic", "toxicspikes","crosspoison"],
		randomDoubleBattleMoves: ["earthquake", "slackoff", "toxicspikes", "stealthrock", "protect", "crosspoison", "whirlwind"],
		tier: "UU",
		doublesTier: "(DUU)",
	},
	skorupi: {
	...
	rotomfan: {
		randomBattleMoves: ["hurricane", "thunderbolt", "voltswitch", "painsplit", "willowisp", "defog"],
		randomDoubleBattleMoves: ["hurricane", "thunderbolt", "voltswitch", "substitute", "painsplit", "hiddenpowerice", "willowisp", "electroweb", "discharge", "protect"],
		tier: "(PU)",
		doublesTier: "(DUU)",
	},
	rotommow: {
	...
	rotomdex: {
		randomBattleMoves: ["flashcannon", "thunderbolt", "voltswitch", "painsplit", "defog", "willowisp", "trick"],
		randomDoubleBattleMoves: ["flashcannon", "thunderbolt", "voltswitch", "substitute", "painsplit", "hiddenpowerice", "willowisp", "trick", "electroweb", "protect", "hiddenpowergrass"],
		tier: "OU",
		doublesTier: "DUU",
	},
	rotomphone: {
		randomBattleMoves: ["psychoboost", "thunderbolt", "voltswitch", "painsplit", "willowisp", "trick"],
		randomDoubleBattleMoves: ["psychoboost", "thunderbolt", "voltswitch", "substitute", "painsplit", "willowisp", "trick", "electroweb", "protect"],
		tier: "RU",
		doublesTier: "(DUU)",
	},
	rotommelee: {
		randomBattleMoves: ["focusblast", "thunderbolt", "voltswitch", "painsplit", "willowisp", "trick"],
		randomDoubleBattleMoves: ["focusblast", "thunderbolt", "voltswitch", "substitute", "painsplit", "willowisp", "trick", "electroweb", "protect"],
		tier: "RU",
		doublesTier: "(DUU)",
	},
	rotomspeak: {
		randomBattleMoves: ["boomburst", "thunderbolt", "voltswitch", "painsplit", "willowisp", "trick"],
		randomDoubleBattleMoves: ["boomburst", "thunderbolt", "voltswitch", "substitute", "painsplit", "willowisp", "trick", "electroweb", "protect"],
		tier: "NU",
		doublesTier: "(DUU)",
	},
	voltergeist: {
	...
	cresseliamega: {
		randomBattleMoves: ["moonlight", "psychic", "icebeam", "thunderwave", "toxic", "substitute", "psyshock", "moonblast", "calmmind", "sparklingaria"],
		randomDoubleBattleMoves: ["psyshock", "icywind", "thunderwave", "trickroom", "moonblast", "moonlight", "skillswap", "reflect", "lightscreen", "icebeam", "protect", "helpinghand", "sparklingaria"],
	...
	darkrai: {
		randomBattleMoves: ["darkvoid", "darkpulse", "focusblast", "nastyplot", "substitute", "perditionspyre"],
	...
	arceusaumagari: {
		randomBattleMoves: ["nastyplot", "calmmind", "judgement", "icebeam", "fireblast", "thunder", "recover"],
		randomDoubleBattleMoves: ["nastyplot", "judgement", "icebeam", "fireblast", "thunder", "recover"],
		tier: "AG",
		doublesTier: "DUber",
	},
	arceusbug: {
	...
	excadrillaumagari: {
		randomBattleMoves: ["swordsdance", "earthquake", "iciclecrash", "ironhead", "rockslide", "rapidspin"],
		randomDoubleBattleMoves: ["swordsdance", "iciclecrash", "earthquake", "rockslide", "ironhead", "substitute", "protect"],
		tier: "UU",
		doublesTier: "DUU",
	},
	audino: {
	...
	darmanitanzen: {
		randomBattleMoves: ["psychic", "fireblast", "focusblast", "hiddenpowerice", "earthquake"],
		randomDoubleBattleMoves: ["psychic", "fireblast", "focusblast", "hiddenpowerice", "earthquake","protect"],
		tier: "RUBL",
		doublesTier: "DUU",
	},
	darmanitangalar: {
	...
	kyuremomnipotent: {
		randomBattleMoves: ["dracometeor", "icebeam", "blueflare", "boltstrike", "dragondance", "outrage", "earthpower", "originstrike", "originflare", "substitute", "roost", "barricade", "toxic"],
		randomDoubleBattleMoves: ["dracometeor", "icebeam", "blueflare", "boltstrike", "dragondance", "outrage", "earthpower", "originstrike", "originflare", "substitute", "roost", "barricade", "toxic", "protect"],
		tier: "AG",
		doublesTier: "DUber",
	},
	keldeo: {
	...
	chesnaughtclemont: {
		randomBattleMoves: ["leechseed", "synthesis", "spikes", "drainpunch", "spikyshield", "woodhammer"],
		eventPokemon: [
			{"generation": 8, "level": 36, "ivs": {"hp": 20, "atk": 31, "def": 20, "spa": 31, "spd": 20, "spe": 31}, "moves": ["woodhammer", "drainpunch", "synthesis", "spikyshield"], "pokeball": "pokeball"},
		],
		gen: 8,
	...
	delphoxserena: {
		randomBattleMoves: ["fireblast", "psyshock", "calmmind", "mysticalfire", "shadowball"],
		eventPokemon: [
			{"generation": 8, "level": 36, "ivs": {"hp": 20, "atk": 31, "def": 20, "spa": 31, "spd": 20, "spe": 31}, "moves": ["fireblast", "psyshock", "calmmind", "mysticalfire"], "pokeball": "pokeball"},
		],
		gen: 8,
		requiredAbility: "Battle Bond",
		battleOnly: true,
	...
	silvallyinfinite: {
		randomBattleMoves: ["multiattack", "thunderbolt", "flamethrower", "uturn", "toxic"],
		randomDoubleBattleMoves: ["protect", "multiattack", "thunderbolt", "partingshot", "uturn", "thunderwave"],
	...
	apocalylidae: {
		...
		randomDoubleBattleMoves: ["apocalypticmaelstrom", "powerwhip", "eruption", "thunder", "bravebird", "oblivionwing", "precipiceblades", "pastsassurance", "protect"],
		tier: "AG",
		doublesTier: "DUber",
	},
};

...
let BattleItems = {
	...
	"leek": {
		...
		onModifyCritRatio(critRatio, user) {
			if ("Sirfetch'd".includes(user.baseTemplate.baseSpecies)) {
				return critRatio + 2;
			}
		},
		num: 259,
		gen: 8,
		desc: "If held by a Sirfetch'd, its critical hit ratio is raised by 2 stages.",
	},
	"leftovers": {
		id: "leftovers",
		name: "Leftovers",
	...
	"togepiumz": {
		...
		zMoveFrom: "Metronome",
		zMoveUser: ["Togepi", "Togetic", "Togekiss"],
		num: -23,
		gen: 8,
	...
	"vivilloniumz": {
		...
		zMoveFrom: "Bug Buzz",
		zMoveUser: ["Vivillon", "Vivillon-Fancy", "Vivillon-Pokeball"],
		num: -21,
		gen: 8,

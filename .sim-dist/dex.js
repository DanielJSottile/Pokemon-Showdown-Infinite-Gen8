...
const BattleNatures = {
	...
	cautious: {name: "Cautious", plus: 'hp', minus: 'atk'},
	conscientious: {name: "Conscientious", plus: 'hp', minus: 'spd'},
	decorous: {name: "Decorous"},
	docile: {name: "Docile"},
	facetious: {name: "Facetious", plus: 'spa', minus: 'hp'},
	fallacious: {name: "Fallacious", plus: 'def', minus: 'hp'},
	fastidious: {name: "Fastidious", plus: 'hp', minus: 'spa'},
	frivolous: {name: "Frivolous", plus: 'spe', minus: 'hp'},
	gentle: {name: "Gentle", plus: 'spd', minus: 'def'},
	hardy: {name: "Hardy"},
	hasty: {name: "Hasty", plus: 'spe', minus: 'def'},
	humorous: {name: "Humorous", plus: 'spd', minus: 'hp'},
	impish: {name: "Impish", plus: 'def', minus: 'spa'},
	jolly: {name: "Jolly", plus: 'spe', minus: 'spa'},
	lax: {name: "Lax", plus: 'def', minus: 'spd'},
	lonely: {name: "Lonely", plus: 'atk', minus: 'def'},
	ludicrous: {name: "Ludicrous", plus: 'atk', minus: 'hp'},
	meticulous: {name: "Meticulous", plus: 'hp', minus: 'atk'},
	...
	scrupulous: {name: "Scrupulous", plus: 'hp', minus: 'spa'},
...
const toID = Data.Tools.getId;
 ...
 class ModdedDex {
	...
	getMove(name) {
		...
		if (id.substr(0, 11) === 'hiddenpower' || id.substr(0, 11) === 'innerpower') {
